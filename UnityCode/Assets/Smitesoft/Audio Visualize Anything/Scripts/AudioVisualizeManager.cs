...
public class AudioVisualizeManager : MonoBehaviour
{
    ...
    public static AudioVisualizeManager visualizeManager;
    ...
    public void StartBeatDetect()
    {
        ...
        /* Play Audio In Speed */
        //audioSource.pitch = 2;
        //float originalLength = audioSource.clip.length;
        //float pitch = audioSource.pitch;
        //float modifiedLength = originalLength / pitch;
        //Debug.Log("Total length of modified audio file: " + modifiedLength + " seconds");
    ...
    private void AdditionalMaths()
    {
        ...
        {
            //Debug.Log("Audio Output is :: " + Output);
            Debug.Log($"<color=red> AUDIO_OUTPUT : </color> " + Output);
            BeatDetect.beatDetect.AddToBeatList(Output);
            BeatDetect.beatDetect.currentTime = audioSource.time;
            BeatDetect.beatDetect.beatTimes.Add(BeatDetect.beatDetect.currentTime);
            LevelGenerator.Instance.myDataList.dataSave.Add(BeatDetect.beatDetect.currentTime);
            //Debug.Log("Current playback time: " + BeatDetect.beatDetect.currentTime + " seconds");
